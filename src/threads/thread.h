...
#define RECENT_CPU_DEFAULT 0 /*#3*/

#define NICE_MIN -20 /*#3*/
#define NICE_MAX 20 /*#3*/
#define NICE_DEFAULT 0 /*#3*/
...
struct thread
  {
    ...
    int64_t wakeup_tick; /* The amount of time to wake up! ### */
